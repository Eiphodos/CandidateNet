...
from methods.oracle.image_utils import get_1d_coords_scale_from_h_w_ps, convert_1d_index_to_2d, convert_2d_index_to_1d
...
class VisionTransformer(nn.Module):
    ...
    def split_input(self, tokens, oracle_labels, patches_scale_coords, curr_scale, patch_size, im):
    ...
    def forward(self, im, oracle_labels):
        ...
        for l_idx in range(len(self.layers)):
            ...
            if l_idx < self.n_scales - 1: 
                ...
                x, patches_scale_coords = self.split_input(x, ol, patches_scale_coords, l_idx, patched_im_size, im)
                PS /= 2
                patched_im_size *= 2
